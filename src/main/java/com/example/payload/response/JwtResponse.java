 ...
 * public class JwtResponse {
 * 
 * private String Type = "Bearer"; private Long id; private String username ;
 * private String email; private String password; public JwtResponse(Long id,
 * String username, String email, String password) { super(); this.id = id;
